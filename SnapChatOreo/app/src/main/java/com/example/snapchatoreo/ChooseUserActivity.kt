...
class ChooseUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chooseUserListView?.onItemClickListener = AdapterView.OnItemClickListener { adapterView, view, position, id ->
            val snapMap = mapOf("from" to FirebaseAuth.getInstance().currentUser!!.email, "imageName" to intent.getStringExtra("imageName"), "imageURL" to intent.getStringExtra("imageURL"), "message" to intent.getStringExtra("message"))
